...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ValidationTextField.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/devikkim@gmail.com/ValidationTextField'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'devikkim@gmail.com' => 'devikkim@gmail.com' }
  s.source           = { :git => 'https://github.com/devikkim@gmail.com/ValidationTextField.git', :tag => s.version.to_s }
